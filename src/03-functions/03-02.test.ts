...
// import {changeBudget, createGreetingMessage, repairHouse, toFireStaff, toHireStaff} from "./03";
//
//
// let city: CityType;
//
...
//     expect(message).toBe("Hello New York citizens. I wish you be happy for all 100000")
// })